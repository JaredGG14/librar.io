...
import { Button, Navbar, NavDropdown, Nav, Row, Col } from 'react-bootstrap';
...
function NavBar() {
    ...
    return (
        <>
            <nav className="navbar NavbarColor bg-gradiant px-3" >
                <div className="container-fluid">
                    {token !== null ? (
                        <Row>
                            ...
                            <Col className='py-2'>
                                <Button variant='outline-secondary' style={{border: 0}} as={Link} to="/librar.io/public/discover/">Discover</Button>
                            </Col>
                            <Col className='py-2'>
                                <Button variant='outline-secondary' style={{border: 0}} as={Link} to="/librar.io/public/goal/">Goal</Button>
                            </Col>
                        </Row>
                    ) : (
                        <Row>
