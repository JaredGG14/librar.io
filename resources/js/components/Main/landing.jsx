        ...
        <div class="container-md py-3">
            ...
            <div className="card my-4 py-5">
                <div className="row">
                    ...
                    <div className="col px-5">
                        <div class="card">
                            <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" fill="currentColor" class="bi bi-bookshelf" viewBox="0 0 16 16">
                    ...
                    <div className="col px-5">
                        <div class="card">
                            <svg xmlns="http://www.w3.org/2000/svg" width="120" height="120" fill="currentColor" class="bi bi-binoculars" viewBox="0 0 16 16">
